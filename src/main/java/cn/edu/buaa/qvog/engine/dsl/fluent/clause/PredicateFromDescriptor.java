...
import cn.edu.buaa.qvog.engine.dsl.data.DataTable;
import cn.edu.buaa.qvog.engine.dsl.data.ITable;
import cn.edu.buaa.qvog.engine.dsl.data.PredicateColumn;
...
public class PredicateFromDescriptor extends BaseFromDescriptor {
    ...
    /**
     * By default, {@link DataTable} will add {@link cn.edu.buaa.qvog.engine.dsl.data.DataColumn},
