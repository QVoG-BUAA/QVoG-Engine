...
public class ControlFlowPredicate extends AbstractFlowPredicate {

    private ControlFlowPredicate(IDbContext dbContext, String sourceTableName, String sinkTableName, String barrierTableName, String alias) {
    ...
    public static IFlowDescriptor builder() {
        return new BaseFlowDescriptor() {
            ...
            public IFlowPredicate exists() {
                return new ControlFlowPredicate(dbContext, sourceTableName, sinkTableName, barrierTableName, alias);
            }
        };
    }
